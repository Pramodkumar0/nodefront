...
export default function Bollywood() {
  ...
  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/bollywoodPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/bollywoodFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/bollywoodTopPost")
