...
export default function Food() {
  ...
  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/foodPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/foodFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/foodTopPost")
