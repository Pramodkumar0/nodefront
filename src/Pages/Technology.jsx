...
const Technology = () => {
  ...
  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/technologyPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/technologyFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/technologyTopPost")
