...
const Fitness = () => {
  ...
  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/fitnessPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/fitnessFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-pramodkumar0.vercel.app/fitnessTopPost")
